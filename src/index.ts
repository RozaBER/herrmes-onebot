/**
 * Hermes/OpenClaw OneBot Channel Plugin
 *
 * 将 OneBot v11 协议（QQ/Lagrange.Core/go-cqhttp）接入 Hermes / OpenClaw Gateway。
 *
 * 发送逻辑（参照飞书实现）：
 * - 由 Hermes/OpenClaw 主包解析 `hermes message send --channel onebot ...` 命令
